...
### Downloading R
To install the R language, go to [this link](https://cran.r-project.org/) and select the Download link that is correct for your operating system. On the next page, select the link 'base', which is just the normal version of R.  
