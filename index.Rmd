...
# Site Navigation
This project is broken down into several sections, which can be accessed by clicking on tabs in the top navigation bar. Make sure to read through the 'Resources' and 'Background' tabs before starting! Exercises can be found in steps 1-4. The assignment can be downloaded from the 'Assignment' tab. <font color=purple>Purple text means that you need to answer a question or paste a screenshot into the assignment.</font>
